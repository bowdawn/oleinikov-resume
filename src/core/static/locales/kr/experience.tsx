...
export const experience_kr: ResumeItemType[] = [
  {
    headers: [
      {
        content:
          "(주)한국은거래소 | 한국은거래소 기업부설연구전담부서장  | 2023.02 - 2023.12",
      },
    ],
    titles: [],
    details: [
      {
        content:
          "시간당 제품 가격 변동 자동화를 강화하고, 금융 데이터를 효과적으로 관리하여 전략적 의사결정을 지원했으며, 사용자 만족도와 작업 효율성을 향상시키기 위한 인터페이스 디자인 혁신을 선도했습니다.",
      },

      // {
      //   content: "• 시간당 제품 가격 변동 자동화를 향상시키는 업무 수행.",
      // },
      // {
      //   content: "• 금융 데이터 관리를 통한 전략적 의사결정 지원.",
      // },
      // {
      //   content:
      //     "• 사용자 만족도와 효율성을 향상시키기 위한 인터페이스 디자인 혁신.",
      // },
    ],
  },
  {
    headers: [{ content: "(주)리우 | 풀스텍 개발자  | 2022.08 - 2023.02" }],
    titles: [],
    details: [
      {
        content:
          "React를 활용하여 쇼핑몰 및 관리 페이지 웹 애플리케이션을 개발하고, React Native를 이용하여 모바일 애플리케이션을 제작했습니다. 또한 Python과 Apollo를 이용하여 Django와 GraphQL을 기반으로 한 Saleor API를 활용한 백엔드 개발을 담당했습니다.",
      },
      // {
      //   content: "• React를 사용하여 쇼핑몰과 관리페이지 웹앱 개발.",
      // },
      // {
      ...
      // {
      //   content:
      //     "• Python, Apollo, Django, GraphQL, 및 Saleor API를 사용한 백엔드 개발 경험.",
      // },
    ],
  },
  {
    headers: [
      { content: "(주)진주소프트 | 풀스텍 개발자 | 2019.10 - 2020.10" },
    ],
    titles: [],
    details: [
      {
