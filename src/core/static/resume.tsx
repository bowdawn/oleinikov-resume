...
export function resume(
 ...
 return {
    ...
    experienceviewmore: <Link target="_blank" rel="noopener noreferrer" href={experience.view_more_link}>{experience.view_more} <ArrowRightOutlined /></Link>,
    ...
    releventcourseworkitem: [
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id6_title },
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id7_title },
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id8_title },
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id9_title },
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id11_title },
        ...
        },
        {
            description:
                [
                    { type: "title", text: relevantcoursework.id12_title },
    ...
    computeritem: [
        {
            description:
                [
                    { type: "title", text: computer.id1_title},
        ...
        },
        {
            description:
                [
                    { type: "title", text: computer.id3_title },
                ]
        },
        {
            description:
                [
                    { type: "title", text: computer.id4_title },
                ]
        },
        {
            description:
                [
                    { type: "title", text: computer.id5_title },
                ]
        },
